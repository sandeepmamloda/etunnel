...
const Herotech = function () {
  ...
  return (
    <section
      ref={sectionRef}
      className={styles["heropclogon-wrapper"]}
      aria-label="Finger Vein Technology - Core Biometric Technology"
    >
      <div className={styles["heropclogon-main"]}>

        <div className={styles["heropclogon-left"]}>

          <div className={styles["heropclogon-left-top"]}>
          ...
          <div className={styles["heropclogon-left-bottom"]}>

            <h2 ref={h2Ref} className={styles["finger-vein"]}>
              <span className={styles["lc-orange"]}>PC Logon</span>
              {" "}
              <span className={styles["lc-black"]}>Solution</span>
            </h2>

            <h3 ref={subHeadRef} className={styles["sub-heading"]}>
              Fast and Secure Biometric-based logon without a password
            </h3>

            <p ref={pRef} className={styles["simple-text"]}>
              <span>
                Revolutionize PC logon with ETUNNEL’s biometric authentication technology. Create a simple and secure password-free environment with our finger vein solution.
              </span>
            </p>
        ...
        <div ref={rightRef} className={styles["heropclogon-right"]}>
          <div className={styles["heropclogon-right-inner"]}>
            <div className={styles["heropclogon-right-outer"]}></div>
          </div>
          <div className={styles["heropclogon-right-img"]}>
            <Image
              src="/images/solutions/pc-logon/hero.png"
              fill={true}
