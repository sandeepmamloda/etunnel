...
import styles from "./herosmartid.module.css";
...
const Herotech = function () {
  ...
  return (
    <section
      ref={sectionRef}
      className={styles["herosmartid-wrapper"]}
      aria-label="Finger Vein Technology - Core Biometric Technology"
    >
      <div className={styles["herosmartid-main"]}>

        <div className={styles["herosmartid-left"]}>

          <div className={styles["herosmartid-left-top"]}>
          ...
          <div className={styles["herosmartid-left-bottom"]}>

            <h2 ref={h2Ref} className={styles["finger-vein"]}>
              <span className={styles["lc-orange"]}>Smart ID</span>
              {" "}
              <span className={styles["lc-black"]}>Project</span>
            </h2>

            <h3 ref={subHeadRef} className={styles["sub-heading"]}>
              A New Standard for Biometric Authentication Platforms for Organizational Integration
            </h3>
        ...
        <div ref={rightRef} className={styles["herosmartid-right"]}>
          <div className={styles["herosmartid-right-inner"]}>
            <div className={styles["herosmartid-right-outer"]}></div>
          </div>
          <div className={styles["herosmartid-right-img"]}>
            <Image
              src="/images/solutions/bas-smart-id-project/bas-smart-id-project.png"
              fill={true}
