                    ...
                    <div className={styles["p2n2info-main-left-text-wrapper"]}>
                        ...
                        <div className={styles["medium-content"]}>
                            <h2 data-anim="p2n2info-h2">
                                Within a single card,we've made identity inseparable from you.
                            </h2>
                        </div>
                        <div className={styles["bottom-content"]}>
                            <p data-anim="p2n2info-p">Smart ID Project — The future of contactless security</p>
                        </div>
                    </div>
                </div>
                <div className={styles["p2n2info-main-right"]} data-anim="p2n2info-img">
                    <Image
                        src="/images/solutions/bas-smart-id-project/info.jpg"
                        fill={true}
                        alt="P2N2 AI Biometric Engine module"
                        priority
                        className={styles["img"]}
