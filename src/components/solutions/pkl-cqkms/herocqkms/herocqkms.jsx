...
import styles from "./herocqkms.module.css";
      ...
      <div className={styles["herocqkms-main"]}>
        ...
        <div className={styles["herocqkms-left"]}>
          ...
          <div className={styles["herocqkms-left-bottom"]}>
            ...
            <h2 ref={h2Ref} className={styles["finger-vein"]}>
              <span className={styles["lc-orange"]}>CQKMS</span>
              {" "}
              <span className={styles["lc-black"]}>(Key Management System, KMS)</span>
            </h2>

            <h3 ref={subHeadRef} className={styles["sub-heading"]}>
              A key management system that securely generates, stores, and operates the keys required for PKI-based digital signatures and encryption.
            </h3>
        ...
        <div ref={rightRef} className={styles["herocqkms-right"]}>
          ...
          <div className={styles["herocqkms-right-img"]}>
            <Image
              src="/images/solutions/pkl-cqkms/herocqkms.png"
              fill={true}
