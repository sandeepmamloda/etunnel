...
import styles from "./herocqframework.module.css";

gsap.registerPlugin(ScrollTrigger);

const Herocqframework = function () {
  ...
  return (
    <section
      ref={sectionRef}
      className={styles["herocqframework-wrapper"]}
      aria-label="CQKMS - Core Biometric Technology"
    >
      <div className={styles["herocqframework-main"]}>

        <div className={styles["herocqframework-left"]}>
          ...
          <div className={styles["herocqframework-left-bottom"]}>

            <h2 ref={h2Ref} className={styles["finger-vein"]}>
              <span className={styles["lc-orange"]}>CQFramework</span>
              {" "}
              <span className={styles["lc-black"]}>- Web-Linked Security Framework</span>
            </h2>
        ...
        <div ref={rightRef} className={styles["herocqframework-right"]}>
          <div className={styles["herocqframework-right-inner"]}>
            <div className={styles["herocqframework-right-outer"]}></div>
          </div>
...
export default Herocqframework;