...
import styles from "./herosafelcert.module.css";
        ...
        <div className={styles["herocqkms-left"]}>
          ...
          <div className={styles["herocqkms-left-bottom"]}>
            ...
            <h2 ref={h2Ref} className={styles["finger-vein"]}>
              <span className={styles["lc-orange"]}>SafeIcert</span>
              {" "}
              <span className={styles["lc-black"]}>- Certificate Management Solution for Businesses</span>
            </h2>
