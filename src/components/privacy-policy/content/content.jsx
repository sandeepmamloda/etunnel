    ...
    <section className={styles.wrapper}>
      ...
      <div className={styles.main}>
        ...
        <p className={styles.intro}>
          Kayana Ltd ("Fiscal", "we", "us") is committed to protecting your personal data.
          This policy describes what we collect, why we collect it, and how you can exercise
        ...
        <section id="section1" className={styles.section}>
          ...
          <p>
            We collect only the data necessary to provide the Fiscal platform and meet our legal obligations.
            Data is gathered in three ways: information you provide directly when signing up or using the service,
            data generated automatically as you interact with the platform, and information received from trusted
        ...
        <section id="section2" className={styles.section}>
          ...
          <p>
            Personal data is used strictly for the purposes disclosed at the time of collection.
            We do not repurpose data without notifying you and, where required by law, obtaining your prior consent.
          </p>
        ...
        <section id="section3" className={styles.section}>
          ...
          <p>
            ...
            satisfy a legal obligation, or protect our legitimate interests. We never sell personal data.
          </p>
        ...
        <section id="section4" className={styles.section}>
          ...
          <p>
            ...
            Requests are processed within 30 days. Note that certain financial records must be retained
            regardless of a deletion request to satisfy statutory obligations.
          </p>
        </section>
        ...
        <section id="section5" className={styles.section}>
          ...
          <p>
            If you are based in the UK or European Economic Area, you have the following rights under UK GDPR
            and EU GDPR. All rights are free to exercise and we will respond within one calendar month
            (extendable by two months for complex requests, with prior notice).
          </p>
          ...
          <p>
            ...
            with the subject "Data Subject Request – [Right]". We may ask you to verify your identity first.
            If you are unsatisfied with our response, you may complain to the{" "}
        ...
        <section id="section6" className={styles.section}>
          ...
          <p className={styles.footnote}>
            This policy was last reviewed by the DPO on 4 June 2026. We will notify active subscribers
            by email at least 14 days before any material changes take effect.
          </p>
        </section>
