...
// ---- Icons (kept as components so they can be reused dynamically) ----
const FingerVeinIcon = () => (
...
const PRODUCT_CATEGORIES = [
  {
    id: "finger-vein",
    label: "Finger Vein Recognition",
    icon: FingerVeinIcon,
    products: [
      { id: "etunnel-r1-100v", name: "ETUNNEL-R1-100V", image: "/images/coretech/kisa-certification/authenticationproducts/etunnel-r1-100v.png" },
      { id: "etunnel-pl-101v", name: "ETUNNEL-PL-101V", image: "/images/coretech/kisa-certification/authenticationproducts/etunnel-pl-101v.png" },
      { id: "etunnel-sw-100v", name: "ETUNNEL-SW-100V", image: "/images/coretech/kisa-certification/authenticationproducts/etunnel-sw-100v.png" },
      { id: "etunnel-cw-100v", name: "ETUNNEL-CW-100V", image: "/images/coretech/kisa-certification/authenticationproducts/etunnel-cw-100v.png" },
    ],
  },
  {
    ...
    products: [
      { id: "etunnel-iv-100m", name: "ETUNNEL-IV-100M", image: "/images/coretech/kisa-certification/authenticationproducts/etunnel-iv-100m.png" },
    ],
  },
];
...
const Authenticationproducts = function () {
  ...
  // reset ref arrays on every render before they get re-populated by callback refs
  categoryHeadingRefs.current = [];
  itemRefs.current = [];
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // ------ category headings (finger vein / facial recognition etc.) ------
      categoryHeadingRefs.current.forEach((el) => {
        if (!el) return;
        gsap.from(el, {
          clipPath: "inset(100% 0% 0% 0%)",
          y: isMobile ? 20 : 30,
            ...
            {PRODUCT_CATEGORIES.map((category, catIndex) => {
              ...
              return (
                <div
                  ...
                  className={
                    catIndex === 0
                      ? styles["authenticationproducts-bottom-1"]
                      : styles["authenticationproducts-bottom-2"]
                  }
                >
                  <div
                    ref={(el) => (categoryHeadingRefs.current[catIndex] = el)}
                  ...
                  <div className={styles["section"]}>
                    {category.products.map((product) => (
                      <div
                        ...
                        className={styles["authenticationproducts-items"]}
                      >
