...
const Herocoverview = function () {
    ...
    return (
        <>
            <section
                ref={sectionRef}
                className={styles["herooverview-section"]}
            >
                <div className={styles["herooverview-section-wrapper"]}>
                    <div className={styles["herooverview-section-img"]}>
                        <Image
                        ...
                        />
                        <div className={styles["herooverview-section-img-overlay"]}></div>
                    </div>
                    <div className={styles["herooverview-section-text-wrapper"]}>
                        <h1 ref={h1Ref}>
