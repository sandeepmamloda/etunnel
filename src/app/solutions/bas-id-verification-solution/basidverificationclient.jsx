...
import Heroverification from "@/components/solutions/bas-id-verification-solution/heroverification/heroverification";
import Nextgeneration from "@/components/solutions/bas-id-verification-solution/nextgeneration/nextgeneration";
import Productshowcase from "@/components/solutions/bas-id-verification-solution/productshowcase/productshowcase";
import Basidverification from "@/components/solutions/bas-id-verification-solution/bas-id-verification/bas-id-verification";
import Solutioncomponents from "@/components/solutions/bas-id-verification-solution/solution-components/solutions-components";
import Varificationflow from "@/components/solutions/bas-id-verification-solution/verification-flow/verification-flow";
import Identityverificationsolution from "@/components/solutions/bas-id-verification-solution/features-of-technology/featureoftechnology";

gsap.registerPlugin(ScrollTrigger);

const Basidverificationclient = () => {
    ...
    return (
        <>
            ...
            <Solutioncomponents />
            <Varificationflow />
            <Identityverificationsolution />
        </>
    );
};

export default Basidverificationclient;